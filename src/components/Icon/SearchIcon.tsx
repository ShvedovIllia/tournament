...
import {IThemeProps, withTheme} from "styles";
import {IIconProps} from "components/Icon/types";

const SearchIconComponent: React.FC<IThemeProps & IIconProps> = ({theme, width = 30, height = 30, color}) => {
  return (
    <svg viewBox="0 0 50 50" width={width} height={height} fill={color ? color : theme.color.white}>
